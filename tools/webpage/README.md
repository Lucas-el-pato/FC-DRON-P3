...
- Python 3.10+
- Flight controller flashed with `TEST_SELECT_TELEMETRY` enabled in `PinCubeMX/tests/test_runner.h`
...
1. Ensure only `TEST_SELECT_TELEMETRY` is uncommented in `PinCubeMX/tests/test_runner.h`.
