...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, led_rojo_Pin|led_verde_Pin|bar_cs_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin : Gyro_Data_Pin */
  GPIO_InitStruct.Pin = Gyro_Data_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_IT_RISING;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  HAL_GPIO_Init(Gyro_Data_GPIO_Port, &GPIO_InitStruct);
  ...
  /*Configure GPIO pins : SD_CS_Pin PB5 */
